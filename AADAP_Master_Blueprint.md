...
| **Frontend** | Next.js 14+ (App Router) | Web UI | Server components, real-time updates, TypeScript |
...
| Task | Files/Components | Validation |
|---|---|---|
| Next.js project scaffold (App Router, TypeScript, Tailwind CSS) | `frontend/` | `npm run dev` starts without errors |
