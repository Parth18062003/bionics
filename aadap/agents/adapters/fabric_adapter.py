...
through integration-client interfaces. Unsupported resource operations are
tracked additively in adapter metadata until client-level support is added.
"""
...
class FabricAdapter(PlatformAdapter):
    """Platform adapter for Microsoft Fabric operations."""
